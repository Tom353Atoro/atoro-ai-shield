        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Atoro is a specialized security consultancy dedicated to helping SaaS companies navigate the complex 
              landscape of cybersecurity, privacy regulations, and AI governance.
            </p>
