      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-1 lg:order-1 relative">
            ...
            {/* Decorative elements */}
            <div className="absolute -z-10 -bottom-6 -left-6 w-64 h-32 bg-gradient-to-br from-atoro-green/10 to-atoro-blue/10 rounded-lg" />
            <div className="absolute -z-10 -top-6 -right-6 w-32 h-64 bg-gradient-to-br from-atoro-blue/10 to-atoro-teal/10 rounded-lg" />
          </div>
